...
public class PublicacionBlogDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.publicacionblog_detail1)).setText(mItem.content);
            ((TextView) rootView.findViewById(R.id.publicacionblog_detail2)).setText(mItem.Description);
        }
